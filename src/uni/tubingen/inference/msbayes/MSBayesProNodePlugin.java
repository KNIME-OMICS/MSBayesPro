 ...
 * @author enrique
 */
public class MSBayesProNodePlugin extends Plugin {
    // The shared instance.
    private static MSBayesProNodePlugin plugin;

    /**
     * The constructor.
     */
    public MSBayesProNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MSBayesProNodePlugin getDefault() {
        return plugin;
    }
